...
function initC2Tracking(): void {
  ...
  // Initial events
  track('airo.website.session', 'session', 'start', { page_path: pathname, referrer: document.referrer });
  track('airo.website.pageview', 'pageview', document.title, { page_path: pathname, referrer: document.referrer });
  ...
  const trackPage = () => {
    if (location.href !== lastUrl) {
      track('airo.website.pageview', 'pageview', document.title, { page_path: pathname, referrer: lastUrl });
